...
//V1.2 - Bufixing -> Wenn Stromstärke extern reguliert wird, beendet u.U. die Ladung
//V1.1 - Energy-Added -> Auswertungen wieviel PV-Strom geladen wurde
//V1.0 - Initiale Erstellung

//=============================Einstellungen/Konfiguration=====================================
//Wo soll das Skript die neuen Objekte anlegen (Mit PV-Überschuss geladene Energy.... )
const ID_SKRIPT_OBJEKT_VERZEICHNIS = "0_userdata.0";
...
const ID_EINSPEISE_LEISTUNG         = "0_userdata.0.Einspeiseleistung"; //Watt  

 //IObroker Objekt ID der Netzbezugsleistung PV
const ID_NETZBEZUG_LEISTUNG         = "0_userdata.0.Netzbezug_Leistung" ; //Watt

//IOBroker Objekt ID zum Tesla, generiert vom Tesla-Adatper (Root)
const ID_TSL                        = "tesla-motors.0.1493041106368476"; 

//Breitengrad Koordinaten der Heimatadresse, somit greift das Skript nur Zuhause
const ZUHAUSE_LATITUDE              = 50.95393; 

//Längengard Koordinaten der Heimatadresse
const ZUHAUSE_LONGITUDE             = 11.107115; //Längengrad Koordinaten

//Maximale Entfernung des Autos von Zuhause
...
const TELEGRAMM_NUTZER              = "Torsten"; // Nutzernamen oder ""
...
const ID_PV_AKKU_SOC                   = "javascript.0.PV-Anlage.Akkustand";
...
const ID_PV_AKKU_STAT = "javascript.0.PV-Anlage.Akku_Status";
