...
const ID_EINSPEISE_LEISTUNG         = "javascript.0.PV-Anlage.Akku_Leistung"; //Watt  

 //IObroker Objekt ID der Netzbezugsleistung PV
const ID_NETZBEZUG_LEISTUNG         = "javascript.0.PV-Anlage.Akku_Leistung" ; //Watt

//IOBroker Objekt ID zum Tesla, generiert vom Tesla-Adatper (Root)
const ID_TSL                        = "tesla-motors.0.LRW3E7EKXNC514071"; 

//Breitengrad Koordinaten der Heimatadresse, somit greift das Skript nur Zuhause
const ZUHAUSE_LATITUDE              = 50.97645; 

//Längengard Koordinaten der Heimatadresse
const ZUHAUSE_LONGITUDE             = 11.264386; //Längengrad Koordinaten
