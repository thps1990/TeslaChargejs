...
{//jede Stunde; Energy berechnen PV Garage
    ...
    //Reine Berechnungen verzögern
     setTimeout(function(){
        ...
        setState("0_userdata.0.PV-Anlage.Energie_Eigenverbrauch_Monthly",EIGENVERBRAUCH_Monthly.toFixed(2));  
        setState("0_userdata.0.PV-Anlage.Energie_Eigenverbrauch_Yearly",EIGENVERBRAUCH_Yearly.toFixed(2));  
